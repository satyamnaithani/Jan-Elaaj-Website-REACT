...
import { Card, CardImg, CardImgOverlay, Form, FormGroup, NavLink, Input} from 'reactstrap';
...
class About extends Component {
	...
	render() {
				...
				<Card>
					...
					<CardImgOverlay style={{ backgroundColor: 'rgba(255, 255, 255, 1'}}>
						<div className="d-flex flex-row flex-wrap justify-content-around">
							...
							<img src={process.env.PUBLIC_URL + '../images/mobile.png'} className="img-fluid" alt="Jan Elaaj User App" />
							</div>
							<div className="md-6" style={styles.container}>
								<h3 style={styles.heading}> Jan Elaaj User App </h3>
								<p style={styles.text}>
									Neighbourhood treatment is one click away
								</p><br/>
        ...
        {' '}{' '}
        <NavLink style={{...loginButton}}>Stay in touch</NavLink>
      </Form>
